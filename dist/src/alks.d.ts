...
export type Auth = StsAuth | PasswordAuth | TokenAuth;
 ...
 * @property addedIAMUserToGroup - whether the user was successfully added to the deny policy group
 */
...
export declare const create: (props: AlksProps) => Alks;
export declare const getAccounts: (props?: GetAccountsProps) => Promise<Account[]>;
export declare const getKeys: (props: GetKeysProps) => Promise<Key>;
export declare const getIAMKeys: (props: GetIAMKeysProps) => Promise<Key>;
export declare const getAllAWSRoleTypes: (props: GetAllAWSRoleTypesProps) => Promise<AwsRoleType[]>;
export declare const getAWSRoleTypes: (props: GetAWSRoleTypesProps) => Promise<string[]>;
export declare const getNonServiceAWSRoleTypes: (props: GetNonServiceAWSRoleTypesProps) => Promise<string[]>;
export declare const createRole: (props: CreateRoleProps) => Promise<Role>;
export declare const createNonServiceRole: (props: CreateNonServiceRoleProps) => Promise<Role>;
export declare const awsAccountRoles: (props: AwsAccountRolesProps) => Promise<AwsAccountRole[]>;
export declare const listAWSAccountRoles: (props: ListAWSAccountRolesProps) => Promise<string[]>;
export declare const getAccountRole: (props: GetAccountRoleProps) => Promise<Role>;
export declare const updateRole: (props: UpdateRoleProps) => Promise<Role>;
export declare const deleteRole: (props: DeleteRoleProps) => Promise<boolean>;
export declare const addRoleMachineIdentity: (props: AddRoleMachineIdentityProps) => Promise<MachineIdentity>;
export declare const deleteRoleMachineIdentity: (props: DeleteRoleMachineIdentityProps) => Promise<MachineIdentity>;
export declare const getUserAccess: (props: GetUserAccessProps) => Promise<User[]>;
export declare const getUserAccessByRole: (props: GetUserAccessByRoleProps) => Promise<Record<string, User[]>>;
export declare const getUserRoleAccess: (props: GetUserRoleAccessProps) => Promise<string[]>;
export declare const getAccountOwners: (props: GetAccountOwnersProps) => Promise<User[]>;
export declare const createAccessKeys: (props: CreateAccessKeysProps) => Promise<LongTermKey>;
export declare const getIamUser: (props: GetIamUserProps) => Promise<IamUser>;
export declare const updateIamUser: (props: UpdateIamUserProps) => Promise<IamUser>;
export declare const deleteIAMUser: (props: DeleteIAMUserProps) => Promise<boolean>;
export declare const version: (props: VersionProps) => Promise<{
    version: string;
}>;
export declare const getLoginRole: (props: GetLoginRoleProps) => Promise<Omit<Account, "skypieaAccount">>;
export declare const getAccessToken: (props: GetAccessTokenProps) => Promise<AccessToken>;
export declare const getRefreshTokens: (props: GetRefreshTokensProps) => Promise<RefreshToken[]>;
export declare const revoke: (props: RevokeProps) => Promise<boolean>;
export declare const getCostTotals: (props: GetCostTotalsProps) => Promise<CostTotal>;
export {};
