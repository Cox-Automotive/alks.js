...
export class Alks {
  ...
  async createRole(props: CreateRoleProps): Promise<Role> {
    const roleTypeExists = props.roleType != null;
    const trustPolicyExists = props.trustPolicy != null;
...
export const getAWSRoleTypes = Alks.prototype.getAWSRoleTypes.bind(defaultAlks);
...
export const awsAccountRoles = Alks.prototype.awsAccountRoles.bind(defaultAlks);
