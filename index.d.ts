declare namespace ALKS {
  ...
  export interface MachineIdentityArn {
  ...
  export class Alks {
    ...
    public addRoleMachineIdentity: (props: AddRoleMachineIdentityProps) => Promise<MachineIdentityArn>;
    public deleteRoleMachineIdentity: (props: DeleteRoleMachineIdentityProps) => Promise<MachineIdentityArn>;
  }
  ...
  export function addRoleMachineIdentity(props: AddRoleMachineIdentityProps): Promise<MachineIdentityArn>;
  export function deleteRole(props: DeleteRoleMachineIdentityProps) : Promise<MachineIdentityArn>;
}
